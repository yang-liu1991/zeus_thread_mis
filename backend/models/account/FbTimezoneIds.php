 ...
 * Created Time: 2016-08-26 10:11:24
 */
...
class FbTimezoneIds 
{
	 ...
	 *	获取timezone name
	 */
	static public function getTimezoneIdName()
	{
		return array_keys(self::getTimezoneIds());
	}

	/**
	 *	获取timezone id
	 */
	static public function getTimezoneId($timezone)
	{
		return self::getTimezoneIds()[$timezone];
	}


	static public function getTimezoneIds()
	{
		return [
			"TZ_AFRICA_ACCRA" => 59,
			"TZ_AFRICA_CAIRO" => 53,
