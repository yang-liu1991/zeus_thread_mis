...
use backend\models\record\AccountInfoSearch;
...
<div class="entity-search">
	...
	<?= $form->field($searchModel, 'company_id')->dropDownList([1002 => '多盟', 1003 => '蓝瀚'], ['prompt'=>'请选择代理', 'style' => 'float:left;width:250px;'])->label('代理筛选') ?>
...
<div class="user-index">
    <?= GridView::widget([
		...
		[
			...
			'format'	=> 'raw',
			'value'		=> function($data) {
				return AccountInfoSearch::getAccountidStr($data->entityInfo['id']);
			},
			'headerOptions' => ['style'=>'text-align:center;font-size:17px;'],
		],
		],
