...
<?php
    ...
    'items' => [
        [
			...
			'url' => Yii::$app->urlManager->createUrl(['admin-manager/entity-list', 'audit_status' => $searchModel::AUDIT_STATUS_ALL]),
        ...
        [
			...
			'headerOptions'	=> ['style' => 'width:100px;text-align:center;'],
			'options' => ['style' => 'margin:0 auto;'],
			'url' => Yii::$app->urlManager->createUrl(['admin-manager/entity-list', 'audit_status' => $searchModel::AUDIT_STATUS_WAIT]),
        ...
        [
			...
			'headerOptions'	=> ['style' => 'width:100px;text-align:center;'],
			'options' => ['style' => 'margin:0 auto;'],
			'url' => Yii::$app->urlManager->createUrl(['admin-manager/entity-list', 'audit_status' => $searchModel::AUDIT_STATUS_FAILED]),
	...
	<?= GridView::widget([
		...
		[
			...
			'value'		=> function ($model, $key, $index, $column) {
				return Html::a($model->name_en, ['admin-manager/entity-view', 'id' => $key]);
			},
			'headerOptions' => ['style'=>'text-align:center;font-size:15px;'],
		],
		[
