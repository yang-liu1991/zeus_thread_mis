...
<div class="entity-search">
    <?php $form = ActiveForm::begin([
        'action' => ['advertiser/account-apply'],
        'method' => 'get',
    ...
    <div class="form-group">
		...
		<?= Html::a('开户列表', ['/advertiser/account-list'], ['class' => 'btn btn-primary']) ?>
    </div>
    <?php ActiveForm::end(); ?>
</div>
    ...
    <?= GridView::widget([
		...
		[
			...
			'value'		=> function ($model, $key, $index, $column) {
				return Html::a($model->name_en, ['advertiser/account-apply-add', 'entity-id' => $key]);
			},
			'headerOptions' => ['style'=>'text-align:center;'],
		],
		[
